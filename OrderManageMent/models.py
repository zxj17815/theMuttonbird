...
class Order(models.Model):
    ...
    state=models.IntegerField("State",choices=((0,'待付款'),(1, '待发货'),(2, '待确认'),(3, '退货中'),(4,'退款中'),(5,'已完成')),default=0,help_text='订单状态[0:待付款,1:待发货,2:待确认,3:退货中,4:退款中,5:已完成]')
...
class Refund(models.Model):
    ...
    refund_type=models.IntegerField("RefundType",choices=((0,'仅退款'),(1,'退货退款')),default=0,help_text='退回类型[0:仅退款,1:退货退款]')
    state=models.IntegerField("State",choices=((0,'待通过'),(1, '待退货'),(2, '待确认'),(3, '已完成'),(4, '未通过')),default=0,help_text='状态[0:待通过,1:待退货,2:待确认,3:已完成,4:未通过]')
